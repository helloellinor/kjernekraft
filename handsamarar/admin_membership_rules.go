...
func (a *App) GetMembershipRules(w http.ResponseWriter, r *http.Request) {
	rules, err := a.DB.GetMembershipRules()
	if err != nil {
...
func (a *App) SaveMembershipRules(w http.ResponseWriter, r *http.Request) {
	...
	if err := a.DB.SaveMembershipRules(&rules); err != nil {
