...
func TestNykelenTolerÅStåIEiAdressa(t *testing.T) {
...
// teiknar henne og ser etter at kvart kronetal som stend der, kjem frå
...
func TestSidaSeierBerreDetBasenSeier(t *testing.T) {
	...
	if err := mal.ExecuteTemplate(&ut, "content", map[string]interface{}{
		...
		// Kjøpsbolken vert berre teikna naar han er vald: tenaren
		// teiknar éi fana, ikkje baae. Sjaa faner.go.
		"Faner": proveFanerekkje("faneark-klippekort", "kjop-klipp", "korta", "kjop-klipp"),
	}); err != nil {
