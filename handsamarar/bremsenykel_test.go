...
// nykelen: ti bomma passord frå kven som helst stengde *heile* huset
// ute i femtan minutt. Det er ikkje ei tryggingsbremsa, det er ein
// av-knapp kven som helst kann trykkja på.
//
// Men hovudlina kann ikkje trupast frå kven som helst heller — då
// skriv ein motstandar berre ei ny adressa for kvart forsøk og vert
// aldri bremsa. Regelen er difor: tru på henne når ho kjem gjenom
// vår eigen mellomtenar (loopback), og aldri elles.
func TestBremsenykelenSkilKundarBakSameTunnelen(t *testing.T) {
	...
	// Utanfrå er hovudlina ei paastand frå ein framand, og ho skal
	...
	// Kjem det ingi hovudlina gjenom tunnelen, fell me attende på det
