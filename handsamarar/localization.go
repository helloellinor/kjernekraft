...
// LastUmsetjingarPåNytt les umsetjingsfilone om att.
//
...
// ikkje, so ein la til ein nykel, oppdaterte sida, og såg sjølve
// nykelen stå der — «admin.people» — og trudde han var skriven gale.
func LastUmsetjingarPåNytt() {
...
func GetLanguageFromRequest(r *http.Request) string {
	...
	// vel — det er det ein fær når ein ikkje hev valt noko.
	return "nn"
}
...
func (l *Localization) T(lang, key string) string {
	...
	// Fell attende på standardmaalet når maalet ikkje finst.
