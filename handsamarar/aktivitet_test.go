...
// millom bygg og mal fell her og ikkje på skjermen.
//
// Han var eit varmekart yver kvar dag fyrr. No er han eit år i 52
// vikeprikkar: lysstyrken segjer kor mange gonger, fargen kva slag.
func TestAktivitetsbolkenTeiknarSeg(t *testing.T) {
	nå := time.Date(2026, 8, 27, 12, 0, 0, 0, time.UTC)
	...
	a := NewActivity("nn", perDag, perType, nå, 52)
	...
	// Full styrke er tri, ikkje fire: aatte timar på ei vika er det
	...
	// grunnen, og då er samandraget og merkelappane avlastinga.
