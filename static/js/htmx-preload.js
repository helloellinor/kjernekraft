// htmx-ext-preload 2.1.1 — henta frå unpkg, uendra.
//
// Han hentar måldokumentet når du peikar på ei lenkje, so klikket fær
// noko som alt ligg der. Same tanken som spekulasjonsreglar, men han
// verkar i kvar nettlesar — og han er bygd for å sitja saman med
// `hx-boost`, som er nett det me nyttar honom til.
//
// Sjaa leidingi i navigation.html: `hx-ext="preload"` slær honom på, og
// `preload="mouseover"` er kva som utløyser hentingi.
(function() {
  /**
