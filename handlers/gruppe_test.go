...
// Gruppone stend paa personen, og dei syner kven han er med i.
func TestGruppemerkaSynerKvaPersonenErMedI(t *testing.T) {
	...
	// Berre merka paa personen — `data-gruppe` stend ogso i lista yver
	...
	// Den han er med i er paa, den andre er av — baae stend der, av di
...
// Ei gruppe skal ikkje sjaa ut som eit løyve.
//
...
func TestGruppaSerIkkjeUtSomEitLoyve(t *testing.T) {
	html := teiknFolk(t,
