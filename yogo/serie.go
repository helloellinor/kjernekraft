...
// som `GrupperTimar` i handlers-pakka nyttar naar han møter timar utan
...
type Serie struct {
	...
	// det importen kjenner ei rekkje att paa, baade i det som kjem inn
...
// SerieNykel kjenner ei rekkje att paa det som er likt kvar gong ho
...
//
// Det er han importen nyttar til aa sjaa kva som alt stend i basen, so
// ei ny køyring ikkje legg inn det same ein gong til.
//
// Læraren og rommet er med, og det er ikkje varsemd — det er noko
// timeplanen faktisk gjer. Her stod «namnet og klokkeslettet», paa den
...
// Apparatus» maandag 17:30, med kvar sin lærar. Med den gamle nykelen
